...
class GetAccountsTaskSet(GatewayGRPCTaskSet):
    ...
    def open_deposit_account(self):
        """
        Открываем депозитный счет для созданного пользователя.
        Проверяем, что предыдущий шаг был успешно создан.
        :return:
        """
    ...
    def get_accounts(self):
        """
        Получаем список счетов, если пользователь был усппешно создан
        :return:
        """
        if not self.create_user_response:
            return
...
class GetAccountsUserScenario(User):
    """
