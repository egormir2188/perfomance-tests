...
from clients.http.gateway.documents.schema import (
    GetTariffDocumentResponseSchema, GetContractDocumentResponseSchema
)
...
class GetTariffDocumentGatewayHTTPClient(HttpClient):
    ...
    def get_tariff_document_api(self, account_id: str) -> Response:
        ...
        return self.get(
            ...
            extensions=HTTPClientExtensions(route='/api/v1/documents/tariff-document')
        )
    ...
    def get_contract_document_api(self, account_id: str) -> Response:
        ...
        return self.get(
            ...
            extensions=HTTPClientExtensions(route='/api/v1/documents/contract-document')
        )
