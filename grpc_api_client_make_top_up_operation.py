...
operations_gateway_grpc_client = build_operations_gateway_grpc_client()
...
make_top_up_operation_response = operations_gateway_grpc_client.make_top_up_operation(
